        ...
        <div className="grid gap-8 lg:gap-12">
          ...
          <section className="bg-light-bg rounded-lg p-6 lg:p-8">
            ...
            <p className="text-light-text leading-relaxed mb-4">
              Founded in 2026, Shofy has rapidly established itself as a trusted and dynamic multipurpose eCommerce platform, dedicated to delivering high-quality products and exceptional customer experiences. We believe that online shopping should be simple, secure, and enjoyable for everyone. By offering a diverse range of products, a user-friendly interface, and reliable service, Shofy strives to redefine convenience and satisfaction in the digital marketplace.
          ...
          <section className="bg-theme-white border border-border-color rounded-lg p-6 lg:p-8">
            ...
            <p className="text-light-text leading-relaxed">
              Our mission is to deliver premium-quality products at competitive prices while providing exceptional customer service at every step. We are dedicated to creating a smooth, secure, and enjoyable shopping experience that goes beyond expectations. Through innovation, reliability, and a customer-first approach, we aim to build lasting trust and meaningful relationships with every customer we serve.
            </p>
          </section>
